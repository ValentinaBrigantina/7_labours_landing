...
export default {
	components: { SidebarHomeOne, HeaderHomeEight, HeroHomeEight, AboutHomeEight, ServicesHomeEight, WorkHomeEight, GetStartedHomeEight, TeamHomeEight, TestimonialHomeEight, BlogHomeEight, SponserHomeEight, FooterHomeEight },
    data(){
        return{
            sidebar:false,
              navs:[
