<template>
  <div>
    ...
    <faq-home-one class="pb-95 pt-90" title="Frequently asked questions" description="Different layouts and styles for team sections."/>
...
export default {
	components: { SidebarHomeOne, HeaderHomeSeven, HeroHomeSeven, FeaturesHomeOne, CounterHomeTwo, DownloadHomeTwo, TeamHomeOne, PriceingHomeTwo, FaqHomeOne, BlogHomeOne, ProjectHomeOne, FooterHomeOne },
            data(){
        return{
            sidebar:false,
            blogs:[
