        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6" v-for="(feature,index) in features" :key="index">
                        ...
                        <div class="col-lg-12">
                            <div class="traffic-btn mt-50">
                                <router-link class="main-btn" to="/about-us">Learn More <i class="fal fa-arrow-right"></i></router-link>
                            </div>
                        </div>
                    </div>
                </div>
