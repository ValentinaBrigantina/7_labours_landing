...
export default {
	components: { HeaderHomeThree, HeroHomeThree, ServicesHomeThree, FunfactHomeThree, AboutHomeThree, ShowCaseHomeThree, DownloadHomeThree, BlogHomeThree, ProjectHomeThree, FooterHomeThree, SidebarHomeOne },
        data(){
        return{
            sidebar:false,
            navs:[
