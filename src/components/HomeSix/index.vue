<template>
  <div>
    ...
    <services-home-two class="pt-90 pb-100" title="How does it work" description="The full monty spiffing good time no biggie cack grub fantastic."/>
...
export default {
	components: { SidebarHomeOne, HeaderHomeSix, HeroHomeSix, ServicesHomeTwo, FeaturesHomeOne, CounterHomeTwo, VideoPlayHomeTwo, DownloadHomeThree, PriceingHomeOne, BlogHomeThree, FooterHomeOne },
        data(){
        return{
            sidebar:false,
